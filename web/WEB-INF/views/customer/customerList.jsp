...
<div id="page-wrapper">
    ...
    <div class="panel panel-default">
        <div class="panel-body">
            <form class="form-inline" action="${pageContext.request.contextPath }/customerAction/list.action"
                  method="post">
                <div class="form-group">
                    <label for="customerName">客户名称</label>
                    <input type="text" class="form-control" id="customerName" value="${queryRequest.cust_name}"
                           name="queryRequest.cust_name">
                </div>
                <div class="form-group">
            ...
            <div class="panel panel-default">
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="javascript:void(0);" onclick="editCustomer(${customer.id})"
                                   class="btn btn-primary btn-xs" data-toggle="modal" data-target="#customerEditDialog">修改</a>
                                <a href="javascript:void(0);" onclick="deleteCustomer(${customer.id})"
                                   class="btn btn-danger btn-xs">删除</a>
                                <a href="javascript:void(0);"
                                   onclick="checkContract('${customer.opportunity}', ${customer.id})"
                                   class="btn btn-success btn-xs">查看合同</a>
                            </td>
                        </tr>
                    </c:forEach>
                    </tbody>
                ...
                <div class="col-md-12 text-right">
                    ...
                    <ul class="pagination ul-group from-horizontal">
                        <li>
                            <a href="${pageContext.request.contextPath}/customerAction/list.action?queryRequest.currentPage=${pagination.first}&amp;queryRequest.cust_name=${queryRequest.cust_name}&amp;queryRequest.cust_source=${queryRequest.cust_source}&amp;queryRequest.cust_industry=${queryRequest.cust_industry}&amp;queryRequest.cust_level=${queryRequest.cust_level}">首页</a>
                        </li>
                        <li>
                            <a href="${pageContext.request.contextPath}/customerAction/list.action?queryRequest.currentPage=${pagination.previous}&amp;queryRequest.cust_name=${queryRequest.cust_name}&amp;queryRequest.cust_source=${queryRequest.cust_source}&amp;queryRequest.cust_industry=${queryRequest.cust_industry}&amp;queryRequest.cust_level=${queryRequest.cust_level}">上一页</a>
                        </li>
                        <li><span>${ pagination.currentPage } / ${pagination.totalPages}</span></li>
                        <li>
                            <a href="${pageContext.request.contextPath}/customerAction/list.action?queryRequest.currentPage=${pagination.next}&amp;queryRequest.cust_name=${queryRequest.cust_name}&amp;queryRequest.cust_source=${queryRequest.cust_source}&amp;queryRequest.cust_industry=${queryRequest.cust_industry}&amp;queryRequest.cust_level=${queryRequest.cust_level}">下一页</a>
                        </li>
                        <li>
                            <a href="${pageContext.request.contextPath}/customerAction/list.action?queryRequest.currentPage=${pagination.last}&amp;queryRequest.cust_name=${queryRequest.cust_name}&amp;queryRequest.cust_source=${queryRequest.cust_source}&amp;queryRequest.cust_industry=${queryRequest.cust_industry}&amp;queryRequest.cust_level=${queryRequest.cust_level}">尾页</a>
                        </li>
                    </ul>
                </div>
            </div>
...
<script type="text/javascript">
    ...
    function checkContract(opportunity, id) {
        if (opportunity != "签订合同") {
            ...
            window.location.href = "<%=basePath%>contractAction/check.action?customerId=" + id;
        }
    }
    ...
    function editCustomer(id) {
        $.ajax({
            ...
            success: function (data) {
                ...
                $("#edit_cust_serialNumber").val(obj["cust_serialNumber"]);
