...
(function(f) {
    void 0 == f.fn.inputmask && (f.inputmask = {
        defaults: {
            ...
            getMaskLength: function(a, d, c) {
                var e = a.length; ! d && 1 < c && (e += a.length * (c - 1));
                return e
            }
        },
        val: f.fn.val,
    ...
    f.fn.inputmask = function(a, d) {
        ...
        function l(a) {
            ...
            c = !1,
            d = !1;
            return f.map(a.split(""),
            function(a) {
                var s = [];
                if (a == h.escapeChar) c = !0;
                else if (a == h.optionalmarker.start && !c) d = b = !0;
                else if (a == h.optionalmarker.end && !c) b = !1,
                d = !0;
                else {
                    var e = h.definitions[a];
                    if (e && !c) {
                        for (var f = e.prevalidator,
                        j = f ? f.length: 0, l = 1; l < e.cardinality; l++) {
                            var g = j >= l ? f[l - 1] : [],
                            k = g.validator,
                            g = g.cardinality;
                            s.push({
                                fn: k ? "string" == typeof k ? RegExp(k) : new
                                function() {
                                    this.test = k
                                }: /./,
                                cardinality: g ? g: 1,
                        ...
                        s.push({
                            fn: e.validator ? "string" == typeof e.validator ? RegExp(e.validator) : new
                            function() {
        ...
        function u() {
            function a(c, d) {
                ...
                1 < y.length ? (f = c + y[0] + (h.optionalmarker.start + y[1] + h.optionalmarker.end) + (1 < e.length ? e[1] : ""), m = j(f), b.push({
                    ...
                    greedy: m.greedy,
                    repeat: m.repeat
                }), 1 < e.length && 1 < e[1].split(h.optionalmarker.start).length && (a(c + y[0] + (h.optionalmarker.start + y[1] + h.optionalmarker.end), e[1]), a(c + y[0], e[1]))) : (f = c + e, m = j(f), b.push({
                    mask: f,
                    _buffer: m.mask,
                    tests: l(f),
                    lastValidPosition: void 0,
            ...
            var b = [];
            f.isArray(h.mask) ? f.each(h.mask,
            function(b, c) {
                a("", c.toString())
            }) : a("", h.mask.toString());
            return b
        ...
        function I(a, b, c, e, d) {
            function j(a, g) {
                ...
                b && (s += b);
                return null != g.tests[d].fn ? g.tests[d].fn.test(s, c, a, e, h) : !1
            }
            if (e) return j(a, q[o]);
            var l = [],
            m = !1,
            ...
            function(e) {
                ...
                if (k != o && !B(a)) {
                    ...
                    this.lastValidPosition = g,
                    !1;
                    g = d ? M(c, a) : A(c, a)
                }
                if ((void 0 == this.lastValidPosition || d || h.numericInput ? this.lastValidPosition <= h.numericInput ? r(c) : A(c, g) : this.lastValidPosition >= M(c, g)) && 0 <= g && g < r(c)) l[e] = j(g, this),
                !1 !== l[e] ? (!0 === l[e] && (l[e] = {
                    pos: g
                }), this.lastValidPosition = l[e].pos || g) : this.lastValidPosition = d ? a == r(c) ? void 0 : A(c, a) : 0 == a ? void 0 : M(c, a)
            });
            o = k;
            T(c, a, k, d);
            m = l[o] || m;
        ...
        function C(a, b, c, e) {
            ...
            for (var g = m = -1,
            p, C = j.length,
            t = 0 == C ? l: -1, x = 0; x < C; x++) for (var v = g + 1; v < l; v++) if (B(v)) {
                var u = j[x]; ! 1 !== (p = I(v, u, b, !c, d)) ? (!0 !== p && (v = void 0 != p.pos ? p.pos: v, u = void 0 != p.c ? p.c: u), J(b, v, u), m = g = v) : (O(b, v), u == G(v) && (t = g = v));
                break
        ...
        function Y(a, b) {
            ...
            e,
            d;
            if (f(a).data("inputmask").isRTL) for (d = 0; d <= c.length - 1; d++) if (e = F(d), z()[e].optionality) if (!B(d) || !I(d, b[d], b, !0)) c.splice(0, 1);
            else break;
            else break;
            else for (d = c.length - 1; 0 <= d; d--) if (e = F(d), z()[e].optionality) if (!B(d) || !I(d, b[d], b, !0)) c.pop();
            else break;
            else break;
            H(a, c)
        }
        ...
        function p(a, b, d) {
            ...
            if ("number" == typeof b) f(a).is(":visible") && (d = "number" == typeof d ? d: b, !1 == h.insertMode && b == d && d++, j.setSelectionRange ? V ? (setTimeout(function() {
                j.selectionStart = b;
        ...
        function P(a) {
                ...
                function(a, b) {
                    ...
                    function(a, b) {
                        if ("inputmask" == b.namespace) {
                            var c = b.handler;
                            b.handler = function() {
                                return this.readOnly || this.disabled ? !1 : c.apply(this, arguments)
                            }
                        }
                    })
                })
            ...
            function d(a) {
                ...
                else if (document.__lookupGetter__ && a.__lookupGetter__("value")) a._valueGet || (a._valueGet = a.__lookupGetter__("value"), a._valueSet = a.__lookupSetter__("value"), a.__defineGetter__("value",
                function() {
                    var a = f(this),
                    b = f(this).data("inputmask"),
                    c = b.masksets,
            ...
            function l(a, b, c) {
                ...
                for (var d = a; d < b && d < r(g); d++) if (B(d)) {
                    ...
                    var e = A(g, d),
                    j = D(g, e);
                    if (j != G(e)) if (e < r(g) && !1 !== I(d, j, g, !0, w) && z()[F(d)].def == z()[F(e)].def) J(g, d, D(g, e)),
                    O(g, e);
                    else {
                        if (B(d)) break
                    } else if (void 0 == c) break
                } else O(g, d);
                void 0 != c && J(g, w ? b: M(g, b), c);
                g = U(g.join(""), w).split("");
            ...
            function u(a, b, c, d) {
                for (; a <= b && a < r(g); a++) if (B(a)) {
                    var e = D(g, a);
                    J(g, a, c);
                    if (e != G(a)) if (c = A(g, a), c < r(g)) if (!1 !== I(c, e, g, !0, w) && z()[F(a)].def == z()[F(c)].def) c = e;
                    else if (B(c)) break;
                    else c = e;
                    else break;
                    else if (!0 !== d) break
            ...
            function y(a) {
                ...
                d = p(b);
                j(b, d);
                if (c == h.keyCode.BACKSPACE || c == h.keyCode.DELETE || aa && 127 == c) {
                    var e = r(g);
                    if (0 == d.begin && d.end == e) o = 0,
                    g = k().slice(),
                    H(b, g),
                    p(b, C(b, g, !1));
                    else if (1 < d.end - d.begin || 1 == d.end - d.begin && h.insertMode) X(g, d.begin, d.end),
                    T(g, d.begin, o),
                    H(b, g, w ? C(b, g, !1) : d.begin);
                    else {
                        var n = $ ? d.end: d.begin;
                        c == h.keyCode.DELETE ? (n < K && (n = K), n < e && (h.numericInput && "" != h.radixPoint && g[n] == h.radixPoint ? (n = g.length - 1 == n ? n: A(g, n), n = l(n, e)) : w ? (n = u(K, n, G(n), !0), n = A(g, n)) : n = l(n, e), T(g, n, o), H(b, g, n))) : c == h.keyCode.BACKSPACE && n > K && (n -= 1, h.numericInput && "" != h.radixPoint && g[n] == h.radixPoint ? (n = u(K, g.length - 1 == n ? n: n - 1, G(n), !0), n++) : w ? (n = u(K, n, G(n), !0), n = g[n + 1] == h.radixPoint ? n + 1 : A(g, n)) : n = l(n, e), T(g, n, o), H(b, g, n))
                    }
                    b._valueGet() == k().join("") && f(b).trigger("cleared");
                    a.preventDefault()
                } else c == h.keyCode.END || c == h.keyCode.PAGE_DOWN ? setTimeout(function() {
                    var c = C(b, g, !1, !0); ! h.insertMode && (c == r(g) && !a.shiftKey) && c--;
                    p(b, a.shiftKey ? d.begin: c, c)
                },
                0) : c == h.keyCode.HOME && !a.shiftKey || c == h.keyCode.PAGE_UP ? p(b, 0, a.shiftKey ? d.begin: 0) : c == h.keyCode.ESCAPE ? (b._valueSet(Q), p(b, 0, C(b, g))) : c == h.keyCode.INSERT ? (h.insertMode = !h.insertMode, p(b, !h.insertMode && d.begin == r(g) ? d.begin - 1 : d.begin)) : a.ctrlKey && 88 == c ? setTimeout(function() {
                    p(b, C(b, g, !0))
                },
                ...
                if (d) {
                    ...
                    if (w) {
                        ...
                        if (!1 !== (m = I(k == s || D(g, k) == h.radixPoint ? M(g, k) : k, j, g, !1, w))) {
                            var E = !1; ! 0 !== m && (E = m.refresh, k = void 0 != m.pos ? m.pos: k, j = void 0 != m.c ? m.c: j);
                            if (!0 !== E) if (s = r(g), m = K, !0 == h.insertMode) {
                                if (!0 == q[o].greedy) for (E = g.slice(); D(E, m, !0) != G(m) && m <= k;) m = m == s ? s + 1 : A(g, m);
                                m <= k && (q[o].greedy || g.length < s) ? (g[K] != G(K) && g.length < s && (E = W(g, -1, w), 0 != n.end && (k += E), s = g.length), l(m, k, j)) : d = !1
                            } else J(g, k, j);
                        ...
                        E = !1; ! 0 !== m && (E = m.refresh, k = void 0 != m.pos ? m.pos: k, j = void 0 != m.c ? m.c: j);
            ...
            if (t.is(":input")) {
                ...
                r(g) > L && -1 < L && (L < k().length && (k().length = L), !1 == q[o].greedy && (q[o].repeat = Math.round(L / k().length)), t.prop("maxLength", 2 * r(g)));
                t.data("inputmask", {
                    masksets: q,
                ...
                M(g, r(g));
                var w = !1;
                if ("rtl" == a.dir || h.numericInput)("rtl" == a.dir || h.numericInput && h.rightAlignNumerics) && t.css("text-align", "right"),
                a.dir = "ltr",
                t.removeAttr("dir"),
                L = t.data("inputmask"),
                L.isRTL = !0,
                ...
                t.bind("mouseenter.inputmask",
                function() {
                    if (!f(this).hasClass("focus.inputmask") && h.showMaskOnHover) {
                ...
                function() {
                    ...
                    if (!S(g)) {
                        ...
                        if (h.clearIncomplete) if (h.clearMaskOnLostFocus) this._valueSet("");
                        else {
                            g = k().slice();
                            H(this, g)
                        }
                ...
                function() {
                    ...
                    0)
                }).bind("keydown.inputmask", y).bind("keypress.inputmask", m).bind("keyup.inputmask", x).bind(ba + ".inputmask dragdrop.inputmask drop.inputmask",
                function() {
                    var a = this;
                    setTimeout(function() {
                        p(a, C(a, g, true));
        ...
        case "unmaskedvalue":
            return q = this.data("inputmask").masksets,
            o = this.data("inputmask").activeMasksetIndex,
            h.definitions = this.data("inputmask").definitions,
            Z(this);
        case "remove":
            return this.each(function() {
                var a = f(this),
                ...
                setTimeout(function() {
                    if (a.data("inputmask")) {
                        ...
                        c && c.get ? b._valueGet && Object.defineProperty(b, "value", {
                            get: b._valueGet,
                            set: b._valueSet
        ...
        case "isComplete":
            ...
            S(this[0].split(""));
        default:
            return b(a, d) || (h.mask = a),
            q = u(),
            this.each(function() {
                P(this)
            })
        } else {
            if ("object" == typeof a) return h = f.extend(!0, {},
            f.inputmask.defaults, a),
            b(h.alias, a),
            q = u(),
            this.each(function() {
                P(this)
                            ...
                            return {
                                validator: function(d, b, j, f, u) {
                                    if (u.regex["urlpre" + (a + 1)]) {
                                        ...
                                        if (!f && !d) {
                                            j -= a;
                                            for (f = 0; f < u.defaultPrefix.length; f++) b[j] = u.defaultPrefix[f],
                                            j++;
                                            for (f = 0; f < z.length - 1; f++) b[j] = z[f],
                                            j++;
                                            return {
                                                pos: j
                                            }
            ...
            definitions: {
                ...
                2 : {
                    validator: function(a, d, c, e, b) {
                        ...
                        f = b.regex.val2(b.separator).test(j + a);
            ...
            definitions: {
                h: {
                    validator: function(a, d, c, e, b) {
                        ...
                        if (!e && !f && (a.charAt(1) == b.timeseparator || -1 != "-.:".indexOf(a.charAt(1)))) if (f = b.regex.hrs.test("0" + a.charAt(0))) return d[c - 1] = "0",
                        d[c] = a.charAt(0),
                        c++,
                        {
                            pos: c
                        };
                        return f && "24" !== b.hourFormat && b.regex.hrs24.test(a) ? (a = parseInt(a, 10), d[c + 5] = 24 == a ? "a": "p", d[c + 6] = "m", a -= 12, 10 > a ? (d[c] = a.toString(), d[c - 1] = "0") : (d[c] = a.toString().charAt(1), d[c - 1] = a.toString().charAt(0)), {
                            pos: c,
                            c: d[c]
                        }) : f
                    },
                ...
                t: {
                    ...
                    prevalidator: [{
                        validator: function(a, d, c, e, b) {
                            if (e = b.regex.ampmpre.test(a)) if (e = b.regex.ampm.test(a + "m")) return d[c] = a,
                            d[c + 1] = "m",
                            c;
                            return e
                        },
    ...
    f.extend(f.inputmask.defaults.aliases, {
        decimal: {
            ...
            getMaskLength: function(a, d, c, e, b) {
                var j = a.length; ! d && 1 < c && (j += a.length * (c - 1));
            ...
            postFormat: function(a, d, c, e) {
                ...
                if (e.autoGroup || c && -1 != b.indexOf(e.groupSeparator)) {
                    for (var b = b.replace(RegExp("\\" + e.groupSeparator, "g"), ""), j = b.split(e.radixPoint), b = j[0], l = RegExp("([-+]?[\\d?]+)([\\d?]{" + e.groupSize + "})"); l.test(b);) b = b.replace(l, "$1" + e.groupSeparator + "$2"),
                    b = b.replace(e.groupSeparator + e.groupSeparator, e.groupSeparator);
            ...
            onKeyDown: function(a, d, c) {
                ...
                if (a.keyCode == c.keyCode.TAB) {
                    if (a = f.inArray(c.radixPoint, d), -1 != a) {
                        for (var b = e.data("inputmask").masksets, e = e.data("inputmask").activeMasksetIndex, j = 1; j <= c.digits && j < c.getMaskLength(b[e]._buffer, b[e].greedy, b[e].repeat, d, c); j++) void 0 == d[a + j] && (d[a + j] = "0");
                        this._valueSet(d.join(""))
                    }
                } else if (a.keyCode == c.keyCode.DELETE || a.keyCode == c.keyCode.BACKSPACE) c.postFormat(d, 0, !0, c),
                this._valueSet(d.join(""))
            },
            definitions: {
                "~": {
                    validator: function(a, d, c, e, b) {
                        ...
                        if (!l && (f += "0", l = b.regex.number(b.groupSeparator, b.groupSize, b.radixPoint, b.digits).test(f), !l)) {
                            ...
                            if (!l && !e && a == b.radixPoint && (l = b.regex.number(b.groupSeparator, b.groupSize, b.radixPoint, b.digits).test("0" + f + "0"))) return d[c] = "0",
                            c++,
                            {
                                pos: c
                            }
